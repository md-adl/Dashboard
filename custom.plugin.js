    ...
    const rules = [{
      ...
      styles: {
        ...
        '&:focus': {
          ...
          'border-color': resolveColor(theme('colors.orange.600', colors.orange[600]), '--tw-border-opacity'),
        },
      },
    }, {
      ...
      styles: {
        color: resolveColor(theme('colors.gray.500', colors.gray[500]), '--tw-text-opacity'), opacity: '1',
      },
    }, {
      ...
      base: ['::-webkit-date-and-time-value'], class: ['.form-input::-webkit-date-and-time-value'], styles: {
        'min-height': '1.5em',
      },
    }, {
      ...
      base: ['select'], class: ['.form-select'], styles: {
      ...
      base: ['[multiple]'], class: null, styles: {
      ...
      base: [`[type='checkbox']`, `[type='radio']`], class: ['.form-checkbox', '.form-radio'], styles: {
        appearance: 'none',
        padding: '0',
        'print-color-adjust': 'exact',
        ...
        height: spacing[4],
        width: spacing[4],
        color: resolveColor(theme('colors.primary.DEFAULT', colors.orange[600]), '--tw-text-opacity'),
        'background-color': '#fff',
        'border-color': resolveColor(theme('colors.default.500', colors.orange[500]), '--tw-border-opacity'),
        'border-width': borderWidth['DEFAULT'],
        '--tw-shadow': '0 0 #0000',
      },
    }, {
      base: [`[type='checkbox']`], class: ['.form-checkbox'], styles: {
        'border-radius': borderRadius['none'],
      },
    }, {
      base: [`[type='radio']`], class: ['.form-radio'], styles: {
        'border-radius': '100%',
      },
    }, {
      ...
      base: [`[type='checkbox']:checked`], class: ['.form-checkbox:checked'], styles: {
      ...
      base: [`[type='radio']:checked`], class: ['.form-radio:checked'], styles: {
      ...
      base: [`[type='checkbox']:indeterminate`], class: ['.form-checkbox:indeterminate'], styles: {
      ...
      base: [`[type='file']`], class: null, styles: {
        background: 'unset',
      ...
      base: [`[type='file']:focus`], class: null, styles: {
